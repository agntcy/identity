...
func (m *V1alpha1RevokeRequest) validateProof(formats strfmt.Registry) error {
...
func (m *V1alpha1RevokeRequest) validateVc(formats strfmt.Registry) error {
...
func (m *V1alpha1RevokeRequest) contextValidateProof(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1RevokeRequest) contextValidateVc(ctx context.Context, formats strfmt.Registry) error {
