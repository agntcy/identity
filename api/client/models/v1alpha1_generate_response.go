...
func (m *V1alpha1GenerateResponse) validateResolverMetadata(formats strfmt.Registry) error {
...
func (m *V1alpha1GenerateResponse) contextValidateResolverMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha1GenerateResponse) UnmarshalBinary(b []byte) error {
	var res V1alpha1GenerateResponse
